        ...
        if ((0 == (r->checked & NODE_CHECKED)) && r->childs != NULL)
        {
            ...
            if (l != NULL)
            {
                ...
                if (! dirh)
                {
                    ...
                    */
                    if (errno == ENOENT && r->old_data != NULL && r->sel_rx_lst == NULL && r->neg_rx_lst == NULL && r->equ_rx_lst == NULL)
                    {
                    ...
                    else if (errno == ENOENT && ((r->sel_rx_lst != NULL || r->neg_rx_lst != NULL || r->equ_rx_lst != NULL) || r->childs != NULL))
                    {
                        ...
                        */
                        error (10, "There are rules referring to non-existent directory %s\n", fullname);
                    }
